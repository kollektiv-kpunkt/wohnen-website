...
<div class="paper-container mdcont">
    <div class="paper">
        ...
        <h4>Was fordert die Initiative der SP?</h4>
        <p>Die Initiative fordert ein Massnahmenpaket, damit in den nächsten Jahren endlich mehr bezahlbare Wohnungen entstehen und die Ausbreitung der Immobilienkonzerne gestoppt werden kann.</p>
        <p style="margin-bottom: 0.25rem"><b>Konkret fordert die Initiative:</b></p>
        <ol>
