...
var chart1 = new Chart(document.getElementById("chart1"), configChart1);
    ...
    datasets: [
        {
            ...
            data: [
                25.5275387, 25.8293048, 26.54325356, 27.24225074, 27.68740979,
                27.97846435, 29.15980905, 30.18146313, 30.79354088, 31.11307763,
                31.78435169, 32, 32.7
            ],
        },
        {
            ...
            data: [
                25.14837401, 25.12466985, 25.04399187, 25.09977992, 24.83142052,
                24.88615362, 24.49238463, 24.49684813, 24.53283265, 24.86659975,
                24.83818947, 24.83818947, 24.7
            ],
        },
    ],
};
...
var chart2 = new Chart(document.getElementById("chart2"), configChart2);
    ...
    datasets: [
        {
            ...
            borderColor: "rgba(31, 31, 143, 1)",
            data: [
                100, 101.27, 111.38, 112.58, 103.64, 101.93, 106.32, 117.95, 139.98,
                130.3, 155.1, 152.17, 156.72, 133.19,
            ],
            tension: 0.3,
        },
        {
            ...
            borderColor: "rgba(255, 0, 0, 1)",
            data: [
                100, 118.14, 136.89, 152.62, 138.61, 142.39, 143.94, 161.99, 151.33,
                165.61, 226.14, 185.55, 211.18, 186.94,
            ],
            tension: 0.3,
        },
        {
            ...
            borderColor: "rgba(128, 0, 128, 1)",
            data: [
                100, 115.1, 144.51, 145.83, 128.78, 124.55, 132.15, 162.09, 175.35,
                159.65, 185.43, 175.51, 213.53, 169.85,
            ],
            tension: 0.3,
        },
    ],
...
var chart3 = new Chart(document.getElementById("chart3"), configChart3);
...
var chart1 = new Chart(document.getElementById("chart4"), configChart4);
...
$(".savechart").click(function () {
    ...
    html2canvas(document.querySelector(`#${$(this).attr("data-ccid")}`)).then(
        function (canvas) {
